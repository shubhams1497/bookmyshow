...
document.getElementById('price-filter').addEventListener('click',showFilterList);
document.getElementById('time-filter').addEventListener('click',showFilterList);


// document.getElementById('price-filter-container').addEventListener('mouseout',hideFilterList);
...
function hideFilterList(e) {
    ...
    if(e.currentTarget.childNodes[3].style.opacity == 1){
      ...
      //  e.currentTarget.childNodes[1].childNodes[1].childNodes[1].style.transformOrigin = "center";
       // e.currentTarget.childNodes[1].childNodes[1].childNodes[1].style.transform  = "rotate(-180deg)";
